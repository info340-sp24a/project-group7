    ...
    <main>
      ...
      <section className="plant-gallery">
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="plant-blurb">They are famous for their natural leaf-holes, which has led to their
              nickname, Swiss Cheese Plant.</p>
          </div>
        </div>
         {/* Plant 2 */}
         <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="plant-blurb">Pothos are beloved for their trailing vines of glossy, heart-shaped leaves and easy
              care requirements.</p>
          </div>
        </div>
          {/* Plant 3 */}
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="plant-blurb">Spider plants are unmistakable with their arching, grassy leaves striped in green and
              white.</p>
          </div>
        </div>
           {/* Plant 4 */}
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="plant-blurb">The upright, sword-like leaves of the snake plant make it an architectural and
        ...
        <div class="card">
          ...
          <div class="card-content">
            <h3 class="plant-name">Cat Palm</h3>
            <p class="plant-blurb">The cat palm is prized for its fluffy, arching fronds of slender green leaves that
        ...
        <div class="card">
          ...
          <div class="card-content">
            <h3 class="plant-name">Chinese Evergreen</h3>
            <p class="plant-blurb">Chinese evergreens have beautiful, oval leaves patterned in shades of green, pink,
      ...
      {/* Plant 7 */}
        <div class="card">
          ...
          <div class="card-content">
            <h3 class="plant-name">Dracaena</h3>
            <p class="plant-blurb">Dracaenas are a diverse group of plants valued for their upright, cane-like stems and
        ...
        <div class="card">
          ...
          <div class="card-content">
            <h3 class="plant-name">ZZ Plant</h3>
            <p class="plant-blurb">The ZZ plant is prized for its thick, waxy stems densely covered in glossy green
              leaves.</p>
          </div>
        </div>
        </div>
