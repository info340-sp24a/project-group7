  ...
  return (
    ...
    <section className="plant-care">
        <div>
            ...
            <h3>Sunlight</h3>
            <p className="plant-blurb">Thrives in bright to medium indirect light. Not suited for intense, direct sun but can be acclimated to withstand it.</p>

            <h3>Water</h3>
            <p className="plant-blurb"> Water every 1-2 weeks, allowing soil to dry out between waterings. Expect to water more often in brighter light and less often in lower light. Pro tip: Monsteras can benefit from filtered water or water left out overnight before using.</p>
        </div>
    </section>
    </main>
    </div>
